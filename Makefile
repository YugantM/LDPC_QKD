...
progs:	modules
	...
	$(COMPILE) encode_emulator.c
	$(LINK) encode_emulator.o mod2sparse.o mod2dense.o mod2convert.o \
	   enc_em.o rcode.o rand.o alloc.o intio.o blockio.o open.o -lm -o encode_emulator
